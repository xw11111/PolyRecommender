...
import os
# Fix OpenMP library conflict (multiple libraries link their own OpenMP runtime)
...
def import_models():
    ...
    mmoe_path = os.path.join(script_dir, "scripts", "mmoe_train.py")
    spec = importlib.util.spec_from_file_location("mmoe_train", mmoe_path)
